...
public class EmployeeWindow extends Stage {
    ...
    private void okAction() {
        ...
        int eYear = Integer.parseInt(txfEmploymentYear.getText().trim());
        ...
        if (employee != null) {
            ...
            Controller.updateEmployee(employee, name, wage, eYear);
            if (companyChecked)
            ...
            // create new employee
            Employee newEmployee = Controller.createEmployee(name, wage, eYear);
            if (companyChecked)
