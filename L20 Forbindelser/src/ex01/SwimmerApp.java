...
public class SwimmerApp {
 ...
 //       ArrayList<TrainingPlan> trainingPlans = new ArrayList<>();
        ...
        System.out.println(mikkel.allTrainingHours());
        System.out.println();

        for (Swimmer s : swimmers){
            System.out.println(s.getName() + "'s træningsplan: " + s.getTrainingPlan().getLevel() + " Samlet træningstid: " + s.allTrainingHours());
        ...
        for (Swimmer s : swimmers) {
            sT += s.allTrainingHours();
        }

        System.out.println();
        System.out.println("Samlet tid: " + sT);
