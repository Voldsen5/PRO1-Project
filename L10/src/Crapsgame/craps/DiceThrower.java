...
import Simplegame.Project1.simple.Die;

public class DiceThrower {
    // use your TwoDice class from the Simple game
    // 2 dice with face count of 6 each
    private Simplegame.Project1.simple.Die die1, die2;
    ...
    public DiceThrower(){
        die1 = new Simplegame.Project1.simple.Die();
        die2 = new Simplegame.Project1.simple.Die();
        this.rollCount = 0;
        this.allFaceValue = 0;
        this.value6 = 0;
        this.sameFace = 0;
    ...
    public Simplegame.Project1.simple.Die getDie1() {
        return die1;
    }
